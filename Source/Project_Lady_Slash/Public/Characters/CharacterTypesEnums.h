...
/*
	ECS_MoveEquipped UMETA(DisplayName = "Move-Equipped")
	ECS_SprintUnequipped UMETA(DisplayName = "Sprint-Unequipped"),
	ECS_SprintEquipped UMETA(DisplayName = "Sprint-Equipped")
